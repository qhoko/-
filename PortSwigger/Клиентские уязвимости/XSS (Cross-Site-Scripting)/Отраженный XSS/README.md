В этом разделе мы объясним, что такое отражённый межсайтовый скриптинг, опишем влияние отражённых XSS-атак и расскажем, как найти уязвимости отражённого XSS.
