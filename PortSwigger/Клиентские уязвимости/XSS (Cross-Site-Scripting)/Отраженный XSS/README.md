В этом разделе мы объясним, что такое отраженный межсайтовый скриптинг, опишем влияние отраженных XSS-атак и расскажем, как найти уязвимости отраженного XSS.
